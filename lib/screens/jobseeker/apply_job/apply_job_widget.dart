...
import 'apply_job_model.dart';
export 'apply_job_model.dart';

/// Add notice period also
class ApplyJobWidget extends StatefulWidget {
  const ApplyJobWidget({
    super.key,
  ...
  static String routePath = '/applyJob';

  @override
  State<ApplyJobWidget> createState() => _ApplyJobWidgetState();
}

class _ApplyJobWidgetState extends State<ApplyJobWidget> {
  late ApplyJobModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApplyJobModel());
    ...
    _model.noticePeriodTextFieldTextController ??= TextEditingController();
    _model.noticePeriodTextFieldFocusNode ??= FocusNode();

    _model.coverLetterTextFieldTextController ??= TextEditingController();
    _model.coverLetterTextFieldFocusNode ??= FocusNode();

    _model.additionalTextFieldTextController ??= TextEditingController();
                    ...
                    children: [
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      onChanged: (_) => EasyDebounce.debounce(
                                        ...
                                        Duration(milliseconds: 1000),
                                        () async {
                                          _model.emailState = _model.emailAddressTextFieldTextController
                                                      .text ==
                                                  '';
                                          safeSetState(() {});
                                        },
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller: _model
                                          .noticePeriodTextFieldTextController,
                                      focusNode:
                                          _model.noticePeriodTextFieldFocusNode,
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.noticePeriodTextFieldTextController',
                                        Duration(milliseconds: 1000),
                                        () => safeSetState(() {}),
                                      ),
                                      autofocus: false,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller:
                                      _model.coverLetterTextFieldTextController,
                                  focusNode:
                                      _model.coverLetterTextFieldFocusNode,
                                  onChanged: (_) => EasyDebounce.debounce(
                                    '_model.coverLetterTextFieldTextController',
                                    Duration(milliseconds: 1000),
                                    () => safeSetState(() {}),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller:
                                      _model.additionalTextFieldTextController,
                                  focusNode:
                                      _model.additionalTextFieldFocusNode,
                                  onChanged: (_) => EasyDebounce.debounce(
                                    '_model.additionalTextFieldTextController',
                                    Duration(milliseconds: 1000),
                                    () => safeSetState(() {}),
                      ...
                      FFButtonWidget(
                        ...
                        options: FFButtonOptions(
                          ...
                          disabledColor: Color(0xFF838181),
                          disabledTextColor: Color(0xFFF3F3F4),
                        ),
